...
// Fetch projects with the category "
$sql = "SELECT * FROM tblprojects WHERE Category = 'Web Technologies'";
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero_caption hero_caption2">
                                ...
                                <br>
                                <br>
                                <h1 data-animation="bounceIn" data-delay="0.2s" style="color:white; font-weight:bold;">Web Technologies Projects</h1>
