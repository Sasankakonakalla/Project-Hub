...
$sql = "SELECT * FROM tblprojects WHERE Category = 'Data Science'";
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-11 col-md-12">
                            <div class="hero_caption hero_caption2">
                                ...
                                <br>
                                <br>
                                <h1 data-animation="bounceIn" data-delay="0.2s" style="color:white; font-weight:bold;">Data Science Projects</h1>
