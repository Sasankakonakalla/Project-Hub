...
if (isset($_POST['submit'])) {
    ...
    if (preg_match("/^[a-zA-Z0-9._%+-]+@(svecw\.edu\.in|gmail\.com)$/", $email)) {
        // Mobile number validation for exactly 10 digits
        if (preg_match("/^[0-9]{10}$/", $mobno)) {
            ...
            echo "<script>alert('Invalid Mobile Number. It should contain exactly 10 digits.');</script>";
        }
    } else {
                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="post">
                            ...
                            <div class="form-floating mb-4">
                                <input type="text" name="mobno" class="form-control" required="true" maxlength="10" pattern="[0-9]{10}">
